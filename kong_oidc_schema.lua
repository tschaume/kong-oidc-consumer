return {
  ...
  fields = {
    ...
    discovery = { type = "string", required = true, default = "https://accounts.google.com/.well-known/openid-configuration" },
    ...
    redirect_uri_path = { type = "string", default = '/cb' },
    redirect_uri_scheme = { type = "string", default = "https" },
    scope = { type = "string", required = true, default = "email" },
    ...
    recovery_page_path = { type = "string", default = '/' },
